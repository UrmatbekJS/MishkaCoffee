...
import "./ColdDrinksAccordion.scss";

const ColdDrinksAccordion = ({ data, setOpenedAccordion, openedAccordion }) => {
  ...
  return (
    <div className="MenuAccordion">
      ...
      >
        <p className="SectionDescription">Холодные напитки</p>
        <p
...
export default ColdDrinksAccordion;
