...
import "./ClassicTeaAccordion.scss";
import { useState } from "react";

const ClassicTeaAccordion = ({ data, setOpenedAccordion, openedAccordion }) => {
  ...
  return (
    <div className="MenuAccordion">
      ...
      >
        <p className="SectionDescription">Классические Чаи</p>
        <p
...
export default ClassicTeaAccordion;
