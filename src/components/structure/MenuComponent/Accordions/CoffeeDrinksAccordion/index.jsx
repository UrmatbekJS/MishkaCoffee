...
import "./CoffeeDrinksAccordion.scss";

const CoffeeDrinksAccordion = ({
  data,
  setOpenedAccordion,
  openedAccordion,
}) => {
  ...
  return (
    <div className="MenuAccordion">
      ...
      >
        <p className="SectionDescription">Кофейные напитки</p>
        <p
...
CoffeeDrinksAccordion.propTypes = {
...
export default CoffeeDrinksAccordion;
