...
import "./HotDrinksAccordion.scss";

const HotDrinksAccordion = ({ data, setOpenedAccordion, openedAccordion }) => {
  ...
  return (
    <div className="MenuAccordion">
      ...
      >
        <p className="SectionDescription">Согревающие напитки</p>
        <p
...
export default HotDrinksAccordion;
