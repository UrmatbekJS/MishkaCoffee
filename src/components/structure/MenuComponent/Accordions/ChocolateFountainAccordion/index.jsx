...
import "./ChocolateFountainAccordion.scss";

const ChocolateFountainAccordion = ({
  data,
  setOpenedAccordion,
  openedAccordion,
}) => {
  ...
  return (
    <div className="MenuAccordion">
      ...
      >
        <p className="SectionDescription">Шоколадный фонтан</p>
        <p
...
ChocolateFountainAccordion.propTypes = {
...
export default ChocolateFountainAccordion;
