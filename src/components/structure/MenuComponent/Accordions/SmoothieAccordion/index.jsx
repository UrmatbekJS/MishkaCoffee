...
import "./SmoothieAccordion.scss";

const SmoothieAccordion = ({ data, setOpenedAccordion, openedAccordion }) => {
  ...
  return (
    <div className="MenuAccordion">
      ...
      >
        <p className="SectionDescription">Смузи</p>
        <p
...
export default SmoothieAccordion;
