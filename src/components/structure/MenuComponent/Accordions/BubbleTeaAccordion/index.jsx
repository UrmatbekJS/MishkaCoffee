...
import "./BubbleTeaAccordion.scss";

const BubbleTeaAccordion = ({ data, setOpenedAccordion, openedAccordion }) => {
  ...
  return (
    <div className="MenuAccordion">
      ...
      >
        <p className="SectionDescription">Bubble-Tea</p>
        <p
...
export default BubbleTeaAccordion;
