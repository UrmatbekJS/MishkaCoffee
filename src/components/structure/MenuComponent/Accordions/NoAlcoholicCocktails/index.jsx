...
import "./NoAlcoholicCocktailsAccordion.scss";

const NoAlcoholicCocktailsAccordion = ({
  data,
  setOpenedAccordion,
  openedAccordion,
}) => {
  ...
  return (
    <div className="MenuAccordion">
      ...
      >
        <p className="SectionDescription">Безалкогольные напитки</p>
        <p
...
NoAlcoholicCocktailsAccordion.propTypes = {
...
export default NoAlcoholicCocktailsAccordion;
