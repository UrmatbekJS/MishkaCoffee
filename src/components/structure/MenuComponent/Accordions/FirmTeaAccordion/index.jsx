...
import "./FirmTeaAccordion.scss";

const FirmTeaAccordion = ({ data, setOpenedAccordion, openedAccordion }) => {
  ...
  return (
    <div className="MenuAccordion">
      ...
      >
        <p className="SectionDescription">Фирменные Чаи</p>
        <p
...
export default FirmTeaAccordion;
